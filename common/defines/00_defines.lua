...
NAir = {
	...
	NAVAL_STRIKE_DAMAGE_TO_STR = 1.25,					-- HER: direct bomb/torpedo damage is limited; critical parts carry most mission kills.
	NAVAL_STRIKE_DAMAGE_TO_ORG = 1.75,					-- HER: air hits disrupt more readily than they destroy hull strength.
...
NNavy = {
	...
	COMBAT_TORPEDO_CRITICAL_CHANCE = 0.15,							-- HER: torpedo hits are especially likely to cause flooding and machinery casualties.
	COMBAT_TORPEDO_CRITICAL_DAMAGE_MULT = 1.5,						-- HER: system casualties, not a universal raw-damage spike, carry torpedo lethality.

	COMBAT_DAMAGE_TO_STR_FACTOR = 0.5,								-- HER: ordinary surface hits cause limited hull loss; catastrophic STR loss comes from criticals.
	...
	COMBAT_BASE_CRITICAL_CHANCE = 0.1,								-- HER: criticals are the primary route to system casualties; reliability still scales this down.
	COMBAT_CRITICAL_DAMAGE_MULT = 2.0,								-- HER: individual critical parts provide severity; avoid stacking every critical with a universal x4 spike.
	...
	CHANCE_TO_DAMAGE_PART_ON_CRITICAL_HIT							= 0.65,	-- HER: most critical hits should produce an actual local or hull-wide system casualty.
	...
	NAVAL_COMBAT_AIR_STRENGTH_TARGET_SCORE = -5,                        -- HER: aircraft prefer combat-capable targets instead of spending strikes on already mission-killed ships.
