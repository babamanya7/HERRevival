...
- Ledo chronology correction: `CHI_ledo_road` now approves the project but no longer opens the route. USA or ENG may begin a 790-day construction decision after 1942-11-30; the completed route is usable no earlier than 1945-01-28 and only while Assam, Mandalay, and Yunnan remain outside enemy control. Initial weekly capacity is `1000`, with three later `+500` expansions to a maximum of `2500`.
