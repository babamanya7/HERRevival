...
static const float GB_CAM_MAX_FILLING_CLAMP = 0.75f; // 0 to 1 value for clamping the fill when camera is at max distance
...
static const float GB_OPACITY_FAR = 1.00;  // Transparency when camera is far
